          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
            <div className="grid grid-cols-1 gap-10 sm:grid-cols-2">
              <div>
                <label
                  htmlFor="name"
                  className="mb-3 block text-xs font-medium tracking-wide text-slate-400 uppercase"
                >
                  Navn
                </label>
                <input
                  ...
                  id="name"
                  {...register("name")}
                  className={`block w-full rounded-none border-0 border-b bg-transparent px-0 py-3 text-white placeholder-slate-600 transition-colors focus:ring-0 focus:outline-none ${
                    errors.name
                      ? "border-red-500 focus:border-red-400"
                      : "border-slate-700 focus:border-[#a7ea00]"
                  }`}
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                {...register("message")}
                className={`block w-full resize-none rounded-none border-0 border-b bg-transparent px-0 py-3 text-white placeholder-slate-600 transition-colors focus:ring-0 focus:outline-none ${
                  errors.message
                    ? "border-red-500 focus:border-red-400"
                    : "border-slate-700 focus:border-[#a7ea00]"
                }`}
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full cursor-pointer bg-white px-8 py-4 text-sm font-medium tracking-wide text-slate-950 transition-all duration-200 hover:bg-[#a7ea00] focus:ring-2 focus:ring-[#a7ea00] focus:ring-offset-2 focus:ring-offset-slate-950 focus:outline-none active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-50"
              >
            ...
            {submitStatus === "success" && (
              <div className="border border-slate-700 bg-slate-900 p-6">
                <p className="text-center text-sm font-medium text-slate-200">
                  Takk for meldingen! Vi tar kontakt innen 1 virkedag.
                </p>
              </div>
            )}

            {submitStatus === "error" && (
              <div className="border border-red-900 bg-red-950/50 p-6">
